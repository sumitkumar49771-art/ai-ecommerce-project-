...
const HERO_SLIDES = [
  ...
  },
  {
    ...
    svg: `<svg viewBox="0 0 320 320" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <linearGradient id="shoe1" x1="0" y1="0" x2="1" y2="0.3">
          <stop offset="0%" stop-color="#10b981"/><stop offset="100%" stop-color="#0891b2"/>
        </linearGradient>
        <linearGradient id="sole1" x1="0" y1="0" x2="1" y2="0">
          <stop offset="0%" stop-color="#f8fafc"/><stop offset="100%" stop-color="#e2e8f0"/>
        </linearGradient>
      </defs>
      <ellipse cx="165" cy="248" rx="128" ry="14" fill="#065f46" opacity="0.12"/>
      <!-- sole -->
      <path d="M46 208 Q40 190 62 182 L100 168 L250 176 Q272 178 274 198 Q276 214 258 218 L64 222 Q50 222 46 208 Z" fill="url(#sole1)" stroke="#cbd5e1" stroke-width="2"/>
      <!-- upper body -->
      <path d="M58 190 Q56 150 96 138 L150 122 Q176 114 196 128 L246 160 Q268 170 266 186 L258 196 L70 200 Q58 198 58 190 Z" fill="url(#shoe1)"/>
      <!-- toe cap -->
      <path d="M58 190 Q56 158 92 144 Q84 168 92 190 Z" fill="#ffffff" opacity="0.9"/>
      <!-- tongue / laces area -->
      <path d="M150 122 Q176 114 196 128 L214 150 Q186 138 160 146 Z" fill="#ecfeff" opacity="0.9"/>
      <line x1="168" y1="132" x2="182" y2="146" stroke="#0e7490" stroke-width="4" stroke-linecap="round"/>
      <line x1="178" y1="126" x2="192" y2="140" stroke="#0e7490" stroke-width="4" stroke-linecap="round"/>
      <line x1="188" y1="122" x2="202" y2="136" stroke="#0e7490" stroke-width="4" stroke-linecap="round"/>
      <!-- heel accent -->
      <path d="M196 128 Q220 118 240 132 L266 160 Q248 152 226 148 Z" fill="#134e4a" opacity="0.35"/>
      <!-- swoosh detail -->
      <path d="M104 172 Q150 190 240 178" fill="none" stroke="#ffffff" stroke-width="5" stroke-linecap="round" opacity="0.55"/>
    </svg>`,
  },
  {
