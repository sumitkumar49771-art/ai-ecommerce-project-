...
exports.updateProduct = async (req, res) => {
  try {
    ...
    // admin left the Image URL field blank (e.g. after renaming the
    // product), fetch a matching real photo here too — otherwise the
    // old image would stay attached to the new name.
    if (!payload.image) {
